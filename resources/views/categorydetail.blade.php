            ...
            <div class="col-lg-3 col-md-4">
                ...
                <div class="bg-light p-4 mb-30">
                    @for($i = 0; $i < count($brands); $i++)
                        <a href="{{route('subCategoryDetail', ['slug' => $slug, 'brand' =>  $brandsslugs[$i]])}}" class="dropdown-item <?php if ($slug == $brandsslugs[$i]){ echo "active";} ?>">{{$brands[$i]}}</a>
                    @endfor
                </div>
                <!-- Color End -->
                ...
                <div class="bg-light p-4 mb-30">
                    @for($i = 0; $i < count($brands); $i++)
                        <a href="{{route('subCategoryDetail', ['slug' => $slug, 'brand' =>  $brandsslugs[$i]])}}"></a>
                    @endfor
                </div>
                <!-- Size End -->
            </div>
